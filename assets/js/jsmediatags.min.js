(function(f){"object"===typeof exports&&"undefined"!==typeof module?module.exports=f():"function"===typeof define&&define.amd?define([],f):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).jsmediatags=f()})(function(){return function(){function f(p,q,m){function l(d,a){if(!q[d]){if(!p[d]){var c="function"==typeof require&&require;if(!a&&c)return c(d,!0);if(e)return e(d,!0);a=Error("Cannot find module '"+d+"'");throw a.code="MODULE_NOT_FOUND",
	...
	typeof c&&"function"!==typeof c?this:c;c._blob=a;c._fileData=new e;return c}m(d,b);l(d,[{key:"_init",value:function(a){this._size=this._blob.size;setTimeout(a.onSuccess,1)}},{key:"loadRange",value:function(a,c){var b=this,h=(this._blob.slice||this._blob.mozSlice||this._blob.webkitSlice).call(this._blob,a[0],a[1]+1),d=new FileReader;d.onloadend=function(h){h=new Uint8Array(d.result);b._fileData.addData(a[0],h);c.onSuccess()};d.onerror=d.onabort=function(a){if(c.onError)c.onError({type:"blob",info:d.error})};
	d.readAsArrayBuffer(h)}},{key:"getByteAt",value:function(a){return this._fileData.getByteAt(a)}}],[{key:"canReadFile",value:function(a){return"undefined"!==typeof Blob&&a instanceof Blob||"undefined"!==typeof File&&a instanceof File}}]);return d}(f("./MediaFileReader"));p.exports=f},{"./ChunkedFileData":5,"./MediaFileReader":11}],5:[function(f,p,q){var m=function(){function f(e,b){for(var d=0;d<b.length;d++){var a=b[d];a.enumerable=a.enumerable||!1;a.configurable=!0;"value"in a&&(a.writable=!0);Object.defineProperty(e,
	a.key,a)}}return function(e,b,d){b&&f(e.prototype,b);d&&f(e,d);return e}}();f=function(){function f(){if(!(this instanceof f))throw new TypeError("Cannot call a class as a function");this._fileData=[]}m(f,null,[{key:"NOT_FOUND",get:function(){return-1}}]);m(f,[{key:"addData",value:function(e,b){var d=e+b.length-1,a=this._getChunkRange(e,d);if(-1===a.startIx)this._fileData.splice(a.insertIx||0,0,{offset:e,data:b});else{var c=this._fileData[a.startIx],g=this._fileData[a.endIx];d=d<g.offset+g.data.length-
	1;var h={offset:Math.min(e,c.offset),data:b};e>c.offset&&(e=this._sliceData(c.data,0,e-c.offset),h.data=this._concatData(e,b));d&&(e=this._sliceData(h.data,0,g.offset-h.offset),h.data=this._concatData(e,g.data));this._fileData.splice(a.startIx,a.endIx-a.startIx+1,h)}}},{key:"_concatData",value:function(e,b){if("undefined"!==typeof ArrayBuffer&&ArrayBuffer.isView&&ArrayBuffer.isView(e)){var d=new e.constructor(e.length+b.length);d.set(e,0);d.set(b,e.length);return d}return e.concat(b)}},{key:"_sliceData",
	value:function(e,b,d){return e.slice?e.slice(b,d):e.subarray(b,d)}},{key:"_getChunkRange",value:function(e,b){for(var d,a,c=-1,g=-1,h=0,k=0;k<this._fileData.length;k++,h=k){a=this._fileData[k].offset;d=a+this._fileData[k].data.length;if(b<a-1)break;if(e<=d+1&&b>=a-1){c=k;break}}if(-1===c)return{startIx:-1,endIx:-1,insertIx:h};for(k=c;k<this._fileData.length&&!(a=this._fileData[k].offset,d=a+this._fileData[k].data.length,b>=a-1&&(g=k),b<=d+1);k++);-1===g&&(g=c);return{startIx:c,endIx:g}}},{key:"hasDataRange",
	value:function(e,b){for(var d=0;d<this._fileData.length;d++){var a=this._fileData[d];if(b<a.offset)break;if(e>=a.offset&&b<a.offset+a.data.length)return!0}return!1}},{key:"getByteAt",value:function(e){for(var b,d=0;d<this._fileData.length;d++){var a=this._fileData[d].offset,c=a+this._fileData[d].data.length-1;if(e>=a&&e<=c){b=this._fileData[d];break}}if(b)return b.data[e-b.offset];throw Error("Offset "+e+" hasn't been loaded yet.");}}]);return f}();p.exports=f},{}],6:[function(f,p,q){function m(a,
	c){if("function"!==typeof c&&null!==c)throw new TypeError("Super expression must either be null or a function, not "+typeof c);a.prototype=Object.create(c&&c.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});c&&(Object.setPrototypeOf?Object.setPrototypeOf(a,c):a.__proto__=c)}var l=function(){function a(a,d){for(var c=0;c<d.length;c++){var b=d[c];b.enumerable=b.enumerable||!1;b.configurable=!0;"value"in b&&(b.writable=!0);Object.defineProperty(a,b.key,b)}}return function(c,
	b,h){b&&a(c.prototype,b);h&&a(c,h);return c}}(),e=[4,132],b=[6,134],d="Other;32x32 pixels 'file icon' (PNG only);Other file icon;Cover (front);Cover (back);Leaflet page;Media (e.g. label side of CD);Lead artist/lead performer/soloist;Artist/performer;Conductor;Band/Orchestra;Composer;Lyricist/text writer;Recording Location;During recording;During performance;Movie/video screen capture;A bright coloured fish;Illustration;Band/artist logotype;Publisher/Studio logotype".split(";");f=function(a){function c(){if(!(this instanceof
	c))throw new TypeError("Cannot call a class as a function");var a=(c.__proto__||Object.getPrototypeOf(c)).apply(this,arguments);if(!this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!a||"object"!==typeof a&&"function"!==typeof a?this:a}m(c,a);l(c,[{key:"_loadData",value:function(a,c){var h=this;a.loadRange([4,7],{onSuccess:function(){h._loadBlock(a,4,c)}})}},{key:"_loadBlock",value:function(a,c,d){var h=this,g=a.getByteAt(c),k=a.getInteger24At(c+1,!0);
	if(-1!==e.indexOf(g)){var n=c+4;a.loadRange([n,n+k],{onSuccess:function(){h._commentOffset=n;h._nextBlock(a,c,g,k,d)}})}else-1!==b.indexOf(g)?(n=c+4,a.loadRange([n,n+k],{onSuccess:function(){h._pictureOffset=n;h._nextBlock(a,c,g,k,d)}})):h._nextBlock(a,c,g,k,d)}},{key:"_nextBlock",value:function(a,c,b,d,e){var h=this;if(127<b)if(h._commentOffset)e.onSuccess();else e.onError({type:"loadData",info:"Comment block could not be found."});else a.loadRange([c+4+d,c+4+4+d],{onSuccess:function(){h._loadBlock(a,
	c+4+d,e)}})}},{key:"_parseData",value:function(a,c){var b=a.getLongAt(this._commentOffset,!1)+(this._commentOffset+4);c=a.getLongAt(b,!1);b+=4;for(var h,g,e,n,x,f,t=0;t<c;t++){var w=a.getLongAt(b,!1),l=a.getStringWithCharsetAt(b+4,w,"utf-8").toString(),m=l.indexOf("=");l=[l.slice(0,m),l.slice(m+1)];switch(l[0]){case "TITLE":h=l[1];break;case "ARTIST":g=l[1];break;case "ALBUM":e=l[1];break;case "TRACKNUMBER":n=l[1];break;case "GENRE":x=l[1]}b+=4+w}this._pictureOffset&&(f=a.getLongAt(this._pictureOffset,
	!0),c=this._pictureOffset+4,b=a.getLongAt(c,!0),t=c+4,c=a.getStringAt(t,b),b=t+b,t=a.getLongAt(b,!0),w=b+4,b=a.getStringWithCharsetAt(w,t,"utf-8").toString(),t=w+t+16,w=a.getLongAt(t,!0),a=a.getBytesAt(t+4,w,!0),f={format:c,type:d[f],description:b,data:a});return{type:"FLAC",version:"1",tags:{title:h,artist:g,album:e,track:n,genre:x,picture:f}}}}],[{key:"getTagIdentifierByteRange",value:function(){return{offset:0,length:4}}},{key:"canReadTagFormat",value:function(a){return"fLaC"===String.fromCharCode.apply(String,
	a.slice(0,4))}}]);return c}(f("./MediaTagReader"));p.exports=f},{"./MediaTagReader":12}],7:[function(f,p,q){function m(b,d){if("function"!==typeof d&&null!==d)throw new TypeError("Super expression must either be null or a function, not "+typeof d);b.prototype=Object.create(d&&d.prototype,{constructor:{value:b,enumerable:!1,writable:!0,configurable:!0}});d&&(Object.setPrototypeOf?Object.setPrototypeOf(b,d):b.__proto__=d)}var l=function(){function b(b,a){for(var c=0;c<a.length;c++){var d=a[c];d.enumerable=
	d.enumerable||!1;d.configurable=!0;"value"in d&&(d.writable=!0);Object.defineProperty(b,d.key,d)}}return function(d,a,c){a&&b(d.prototype,a);c&&b(d,c);return d}}();q=f("./MediaTagReader");f("./MediaFileReader");f=function(b){function d(){if(!(this instanceof d))throw new TypeError("Cannot call a class as a function");var a=(d.__proto__||Object.getPrototypeOf(d)).apply(this,arguments);if(!this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!a||"object"!==
	typeof a&&"function"!==typeof a?this:a}m(d,b);l(d,[{key:"_loadData",value:function(a,c){var b=a.getSize();a.loadRange([b-128,b-1],c)}},{key:"_parseData",value:function(a,c){var b=a.getSize()-128,d=a.getStringWithCharsetAt(b+3,30).toString(),k=a.getStringWithCharsetAt(b+33,30).toString(),u=a.getStringWithCharsetAt(b+63,30).toString(),r=a.getStringWithCharsetAt(b+93,4).toString();var f=a.getByteAt(b+97+28);c=a.getByteAt(b+97+29);if(0==f&&0!=c){var n="1.1";f=a.getStringWithCharsetAt(b+97,28).toString()}else n=
	"1.0",f=a.getStringWithCharsetAt(b+97,30).toString(),c=0;a=a.getByteAt(b+97+30);a={type:"ID3",version:n,tags:{title:d,artist:k,album:u,year:r,comment:f,genre:255>a?e[a]:""}};c&&(a.tags.track=c);return a}}],[{key:"getTagIdentifierByteRange",value:function(){return{offset:-128,length:128}}},{key:"canReadTagFormat",value:function(a){return"TAG"===String.fromCharCode.apply(String,a.slice(0,3))}}]);return d}(q);var e="Blues;Classic Rock;Country;Dance;Disco;Funk;Grunge;Hip-Hop;Jazz;Metal;New Age;Oldies;Other;Pop;R&B;Rap;Reggae;Rock;Techno;Industrial;Alternative;Ska;Death Metal;Pranks;Soundtrack;Euro-Techno;Ambient;Trip-Hop;Vocal;Jazz+Funk;Fusion;Trance;Classical;Instrumental;Acid;House;Game;Sound Clip;Gospel;Noise;AlternRock;Bass;Soul;Punk;Space;Meditative;Instrumental Pop;Instrumental Rock;Ethnic;Gothic;Darkwave;Techno-Industrial;Electronic;Pop-Folk;Eurodance;Dream;Southern Rock;Comedy;Cult;Gangsta;Top 40;Christian Rap;Pop/Funk;Jungle;Native American;Cabaret;New Wave;Psychadelic;Rave;Showtunes;Trailer;Lo-Fi;Tribal;Acid Punk;Acid Jazz;Polka;Retro;Musical;Rock & Roll;Hard Rock;Folk;Folk-Rock;National Folk;Swing;Fast Fusion;Bebob;Latin;Revival;Celtic;Bluegrass;Avantgarde;Gothic Rock;Progressive Rock;Psychedelic Rock;Symphonic Rock;Slow Rock;Big Band;Chorus;Easy Listening;Acoustic;Humour;Speech;Chanson;Opera;Chamber Music;Sonata;Symphony;Booty Bass;Primus;Porn Groove;Satire;Slow Jam;Club;Tango;Samba;Folklore;Ballad;Power Ballad;Rhythmic Soul;Freestyle;Duet;Punk Rock;Drum Solo;Acapella;Euro-House;Dance Hall".split(";");
	...
	}e(b,null,[{key:"getFrameReaderFunction",value:function(a){return a in c?c[a]:"T"===a[0]?c["T*"]:"W"===a[0]?c["W*"]:null}},{key:"readFrames",value:function(a,c,d,h,g){for(var k={},e=this._getFrameHeaderSize(h);a<c-e;){var u=this._readFrameHeader(d,a,h),f=u.id;if(!f)break;var n=u.flags,r=u.size,v=a+u.headerSize,l=d;a+=u.headerSize+u.size;if(!g||-1!==g.indexOf(f)){if("MP3e"===f||"\x00MP3"===f||"\x00\x00MP"===f||" MP3"===f)break;n&&n.format.unsynchronisation&&(l=this.getUnsyncFileReader(l,v,r),v=0,r=
	l.getSize());n&&n.format.data_length_indicator&&(v+=4,r-=4);n=(u=b.getFrameReaderFunction(f))?u.apply(this,[v,r,l,n,h]):null;v=this._getFrameDescription(f);r={id:f,size:r,description:v,data:n};f in k?(k[f].id&&(k[f]=[k[f]]),k[f].push(r)):k[f]=r}}return k}},{key:"_getFrameHeaderSize",value:function(a){a=a.major;return 2==a?6:3==a||4==a?10:0}},{key:"_readFrameHeader",value:function(a,c,b){var d=b.major,h=null;b=this._getFrameHeaderSize(b);switch(d){case 2:var g=a.getStringAt(c,3);var k=a.getInteger24At(c+
	...
	function(a,c,b,d,g){d=m(b.getByteAt(a));return b.getStringWithCharsetAt(a+1,c-1,d).toString()};c.TXXX=function(a,c,b,d,g){d=m(b.getByteAt(a));return l(a,c,b,d)};c.WXXX=function(a,c,b,d,g){if(0===c)return null;d=m(b.getByteAt(a));return l(a,c,b,d)};c["W*"]=function(a,c,b,d,g){return 0===c?null:b.getStringWithCharsetAt(a,c,"iso-8859-1").toString()};c.TCON=function(a,b,d,g){return c["T*"].apply(this,arguments).replace(/^\(\d+\)/,"")};c.TCO=c.TCON;c.USLT=function(a,c,b,d,g){var h=a,e=m(b.getByteAt(a));
	d=b.getStringAt(a+1,3);g=b.getStringWithCharsetAt(a+4,c-4,e);a+=4+g.bytesReadCount;a=b.getStringWithCharsetAt(a,h+c-a,e);return{language:d,descriptor:g.toString(),lyrics:a.toString()}};c.ULT=c.USLT;c.UFID=function(a,c,d,g,e){g=b.readNullTerminatedString(d.getBytesAt(a,c));a+=g.bytesReadCount;a=d.getBytesAt(a,c-g.bytesReadCount);return{ownerIdentifier:g.toString(),identifier:a}};var g="Other;32x32 pixels 'file icon' (PNG only);Other file icon;Cover (front);Cover (back);Leaflet page;Media (e.g. label side of CD);Lead artist/lead performer/soloist;Artist/performer;Conductor;Band/Orchestra;Composer;Lyricist/text writer;Recording Location;During recording;During performance;Movie/video screen capture;A bright coloured fish;Illustration;Band/artist logotype;Publisher/Studio logotype".split(";");
	...
	return!a||"object"!==typeof a&&"function"!==typeof a?this:a}m(c,a);l(c,[{key:"_loadData",value:function(a,c){var b=this;a.loadRange([0,16],{onSuccess:function(){b._loadAtom(a,0,"",c)},onError:c.onError})}},{key:"_loadAtom",value:function(a,c,b,d){if(c>=a.getSize())d.onSuccess();else{var g=this,e=a.getLongAt(c,!0);if(0==e||isNaN(e))d.onSuccess();else{var h=a.getStringAt(c+4,4);if(this._isContainerAtom(h)){"meta"==h&&(c+=4);var f=(b?b+".":"")+h;"moov.udta.meta.ilst"===f?a.loadRange([c,c+e],d):a.loadRange([c+
	8,c+8+8],{onSuccess:function(){g._loadAtom(a,c+8,f,d)},onError:d.onError})}else a.loadRange([c+e,c+e+8],{onSuccess:function(){g._loadAtom(a,c+e,b,d)},onError:d.onError})}}}},{key:"_isContainerAtom",value:function(a){return 0<=["moov","udta","meta","ilst"].indexOf(a)}},{key:"_canReadAtom",value:function(a){return"----"!==a}},{key:"_parseData",value:function(a,c){var b={};c=this._expandShortcutTags(c);this._readAtom(b,a,0,a.getSize(),c);for(var e in d)d.hasOwnProperty(e)&&(c=b[d[e]])&&(b[e]="track"===
	e?c.data.track:c.data);return{type:"MP4",ftyp:a.getStringAt(8,4),version:a.getLongAt(12,!0),tags:b}}},{key:"_readAtom",value:function(a,c,b,d,e,f,n){n=void 0===n?"":n+"  ";for(var g=b;g<b+d;){var h=c.getLongAt(g,!0);if(0==h)break;var k=c.getStringAt(g+4,4);if(this._isContainerAtom(k)){"meta"==k&&(g+=4);this._readAtom(a,c,g+8,h-8,e,(f?f+".":"")+k,n);break}(!e||0<=e.indexOf(k))&&"moov.udta.meta.ilst"===f&&this._canReadAtom(k)&&(a[k]=this._readMetadataAtom(c,g));g+=h}}},{key:"_readMetadataAtom",value:function(a,
	c){var d=a.getLongAt(c,!0),g=a.getStringAt(c+4,4),f=a.getInteger24At(c+16+1,!0);f=e[f];if("trkn"==g)var h={track:a.getByteAt(c+16+11),total:a.getByteAt(c+16+13)};else if("disk"==g)h={disk:a.getByteAt(c+16+11),total:a.getByteAt(c+16+13)};else{c+=24;var n=d-24;"covr"===g&&"uint8"===f&&(f="jpeg");switch(f){case "text":h=a.getStringWithCharsetAt(c,n,"utf-8").toString();break;case "uint8":h=a.getShortAt(c,!1);break;case "int":case "uint":h=("int"==f?1==n?a.getSByteAt:2==n?a.getSShortAt:4==n?a.getSLongAt:
	a.getLongAt:1==n?a.getByteAt:2==n?a.getShortAt:a.getLongAt).call(a,c+(8==n?4:0),!0);break;case "jpeg":case "png":h={format:"image/"+f,data:a.getBytesAt(c,n)}}}return{id:g,size:d,description:b[g]||"Unknown",data:h}}},{key:"getShortcuts",value:function(){return d}}],[{key:"getTagIdentifierByteRange",value:function(){return{offset:0,length:16}}},{key:"canReadTagFormat",value:function(a){return"ftyp"===String.fromCharCode.apply(String,a.slice(4,8))}}]);return c}(q);var e={0:"uint8",1:"text",13:"jpeg",
	14:"png",21:"int",22:"uint"},b={"\u00a9alb":"Album","\u00a9ART":"Artist",aART:"Album Artist","\u00a9day":"Release Date","\u00a9nam":"Title","\u00a9gen":"Genre",gnre:"Genre",trkn:"Track Number","\u00a9wrt":"Composer","\u00a9too":"Encoding Tool","\u00a9enc":"Encoded By",cprt:"Copyright",covr:"Cover Art","\u00a9grp":"Grouping",keyw:"Keywords","\u00a9lyr":"Lyrics","\u00a9cmt":"Comment",tmpo:"Tempo",cpil:"Compilation",disk:"Disc Number",tvsh:"TV Show Name",tven:"TV Episode ID",tvsn:"TV Season",tves:"TV Episode",
	...
	d,a){d&&e(b.prototype,d);a&&e(b,a);return b}}(),l=function(){function e(b,d){if(!(this instanceof e))throw new TypeError("Cannot call a class as a function");this._value=b;this.bytesReadCount=d;this.length=b.length}m(e,[{key:"toString",value:function(){return this._value}}]);return e}();p.exports={readUTF16String:function(e,b,d){var a=0,c=1,g=0;d=Math.min(d||e.length,e.length);254==e[0]&&255==e[1]?(b=!0,a=2):255==e[0]&&254==e[1]&&(b=!1,a=2);b&&(c=0,g=1);b=[];for(var f=0;a<d;f++){var k=e[a+c],m=(k<<
	8)+e[a+g];a+=2;if(0==m)break;else 216>k||224<=k?b[f]=String.fromCharCode(m):(k=(e[a+c]<<8)+e[a+g],a+=2,b[f]=String.fromCharCode(m,k))}return new l(b.join(""),a)},readUTF8String:function(e,b){var d=0;b=Math.min(b||e.length,e.length);239==e[0]&&187==e[1]&&191==e[2]&&(d=3);for(var a=[],c=0;d<b;c++){var g=e[d++];if(0==g)break;else if(128>g)a[c]=String.fromCharCode(g);else if(194<=g&&224>g){var f=e[d++];a[c]=String.fromCharCode(((g&31)<<6)+(f&63))}else if(224<=g&&240>g){f=e[d++];var k=e[d++];a[c]=String.fromCharCode(((g&
	...
	b))throw new TypeError("Cannot call a class as a function");}function l(a,b){var c=0>a.offset&&(-a.offset>b||0<a.offset+a.length);return!(0<=a.offset&&a.offset+a.length>=b||c)}var e=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1;d.configurable=!0;"value"in d&&(d.writable=!0);Object.defineProperty(a,d.key,d)}}return function(b,c,d){c&&a(b.prototype,c);d&&a(b,d);return b}}();f("./MediaFileReader");var b=f("./XhrFileReader"),d=f("./BlobFileReader"),a=
	f("./ArrayFileReader");f("./MediaTagReader");var c=f("./ID3v1TagReader"),g=f("./ID3v2TagReader"),h=f("./MP4TagReader"),k=f("./FLACTagReader"),u=[],r=[],v=function(){function a(b){m(this,a);this._file=b}e(a,[{key:"setTagsToRead",value:function(a){this._tagsToRead=a;return this}},{key:"setFileReader",value:function(a){this._fileReader=a;return this}},{key:"setTagReader",value:function(a){this._tagReader=a;return this}},{key:"read",value:function(a){var b=new (this._getFileReader())(this._file),c=this;
	b.init({onSuccess:function(){c._getTagReader(b,{onSuccess:function(d){(new d(b)).setTagsToRead(c._tagsToRead).read(a)},onError:a.onError})},onError:a.onError})}},{key:"_getFileReader",value:function(){return this._fileReader?this._fileReader:this._findFileReader()}},{key:"_findFileReader",value:function(){for(var a=0;a<u.length;a++)if(u[a].canReadFile(this._file))return u[a];throw Error("No suitable file reader found for "+this._file);}},{key:"_getTagReader",value:function(a,b){if(this._tagReader){var c=
	this._tagReader;setTimeout(function(){b.onSuccess(c)},1)}else this._findTagReader(a,b)}},{key:"_findTagReader",value:function(a,b){for(var c=[],d=[],e=a.getSize(),f=0;f<r.length;f++){var g=r[f].getTagIdentifierByteRange();l(g,e)&&(0<=g.offset&&g.offset<e/2||0>g.offset&&g.offset<-e/2?c.push(r[f]):d.push(r[f]))}var h=!1;f={onSuccess:function(){if(h){for(var c=0;c<r.length;c++){var d=r[c].getTagIdentifierByteRange();if(l(d,e)){try{var f=a.getBytesAt(0<=d.offset?d.offset:d.offset+e,d.length)}catch(z){if(b.onError)b.onError({type:"fileReader",
	info:z.message});return}if(r[c].canReadTagFormat(f)){b.onSuccess(r[c]);return}}}if(b.onError)b.onError({type:"tagFormat",info:"No suitable tag reader found"})}else h=!0},onError:b.onError};this._loadTagIdentifierRanges(a,c,f);this._loadTagIdentifierRanges(a,d,f)}},{key:"_loadTagIdentifierRanges",value:function(a,b,c){if(0===b.length)setTimeout(c.onSuccess,1);else{for(var d=[Number.MAX_VALUE,0],e=a.getSize(),f=0;f<b.length;f++){var g=b[f].getTagIdentifierByteRange(),h=0<=g.offset?g.offset:g.offset+
	e;g=h+g.length-1;d[0]=Math.min(h,d[0]);d[1]=Math.max(g,d[1])}a.loadRange(d,c)}}}]);return a}();q=function(){function a(){m(this,a)}e(a,null,[{key:"addFileReader",value:function(b){u.push(b);return a}},{key:"addTagReader",value:function(b){r.push(b);return a}},{key:"removeTagReader",value:function(b){b=r.indexOf(b);0<=b&&r.splice(b,1);return a}},{key:"EXPERIMENTAL_avoidHeadRequests",value:function(){b.setConfig({avoidHeadRequests:!0})}},{key:"setDisallowedXhrHeaders",value:function(a){b.setConfig({disallowedXhrHeaders:a})}},
	{key:"setXhrTimeoutInSec",value:function(a){b.setConfig({timeoutInSec:a})}}]);return a}();q.addFileReader(b).addFileReader(d).addFileReader(a).addTagReader(g).addTagReader(c).addTagReader(h).addTagReader(k);"undefined"===typeof process||process.browser||(f="undefined"!==typeof navigator&&"ReactNative"===navigator.product?f("./ReactNativeFileReader"):f("./NodeFileReader"),q.addFileReader(f));p.exports={read:function(a,b){(new v(a)).read(b)},Reader:v,Config:q}},{"./ArrayFileReader":3,"./BlobFileReader":4,
	"./FLACTagReader":6,"./ID3v1TagReader":7,"./ID3v2TagReader":9,"./MP4TagReader":10,"./MediaFileReader":11,"./MediaTagReader":12,"./NodeFileReader":1,"./ReactNativeFileReader":1,"./XhrFileReader":14}]},{},[15])(15)});